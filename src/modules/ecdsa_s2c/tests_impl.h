...
static void test_ecdsa_s2c_api(void) {
    ...
    ecount = 0;
    CHECK(secp256k1_ecdsa_s2c_sign(both, NULL, &s2c_opening, msg, sec, s2c_data, NULL) == 0);
    CHECK(ecount == 1);
    CHECK(secp256k1_ecdsa_s2c_sign(both, &sig, NULL, msg, sec, s2c_data, NULL) == 1);
    CHECK(ecount == 1); /* NULL opening is not an API error */
    CHECK(secp256k1_ecdsa_s2c_sign(both, &sig, &s2c_opening, NULL, sec, s2c_data, NULL) == 0);
    CHECK(ecount == 2);
    CHECK(secp256k1_ecdsa_s2c_sign(both, &sig, &s2c_opening, msg, NULL, s2c_data, NULL) == 0);
    CHECK(ecount == 3);
    CHECK(secp256k1_ecdsa_s2c_sign(both, &sig, &s2c_opening, msg, sec, NULL, NULL) == 0);
    CHECK(ecount == 4);
    CHECK(secp256k1_ecdsa_s2c_sign(none, &sig, &s2c_opening, msg, sec, s2c_data, NULL) == 1);
    CHECK(secp256k1_ecdsa_s2c_sign(vrfy, &sig, &s2c_opening, msg, sec, s2c_data, NULL) == 1);
    CHECK(secp256k1_ecdsa_s2c_sign(sign, &sig, &s2c_opening, msg, sec, s2c_data, NULL) == 1);
    CHECK(ecount == 4);
    CHECK(secp256k1_ecdsa_s2c_sign(sttc, &sig, &s2c_opening, msg, sec, s2c_data, NULL) == 0);
    CHECK(ecount == 5);
    ...
    CHECK(secp256k1_ecdsa_s2c_sign(sign, &sig, NULL, msg, sec, s2c_data, NULL) == 1);
    CHECK(secp256k1_ecdsa_s2c_verify_commit(vrfy, &sig, s2c_data, &s2c_opening) == 1);
    ...
    ecount = 0;
    CHECK(secp256k1_anti_exfil_sign(both, NULL, msg, sec, hostrand, NULL) == 0);
    CHECK(ecount == 1);
    CHECK(secp256k1_anti_exfil_sign(both, &sig, NULL, sec, hostrand, NULL) == 0);
    CHECK(ecount == 2);
    CHECK(secp256k1_anti_exfil_sign(both, &sig, msg, NULL, hostrand, NULL) == 0);
    CHECK(ecount == 3);
    CHECK(secp256k1_anti_exfil_sign(both, &sig, msg, sec, NULL, NULL) == 0);
    CHECK(ecount == 4);
    CHECK(secp256k1_anti_exfil_sign(none, &sig, msg, sec, hostrand, NULL) == 1);
    CHECK(secp256k1_anti_exfil_sign(vrfy, &sig, msg, sec, hostrand, NULL) == 1);
    CHECK(secp256k1_anti_exfil_sign(both, &sig, msg, sec, hostrand, NULL) == 1);
    CHECK(ecount == 4);
    CHECK(secp256k1_anti_exfil_sign(sttc, &sig, msg, sec, hostrand, NULL) == 0);
    CHECK(ecount == 5);
